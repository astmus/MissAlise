...
internal sealed class TelegramWorkflowUpdateResultVisitor : WorkflowUpdateResultVisitor
{
    private readonly Bot _bot;

    public TelegramWorkflowUpdateResultVisitor(IHandleContext context, Bot bot)
        : base(context)
    {
        _bot = bot;
    }

    protected override Task VisitMessageAsync(Message message, WorkflowHandleResult result, CancellationToken cancellationToken)
    {
