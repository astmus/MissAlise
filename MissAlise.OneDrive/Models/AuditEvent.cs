...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class AuditEvent : global::MissAlise.OneDrive.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.AuditActor? Actor { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.AuditActor Actor { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.AuditResource>? Resources { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.AuditResource> Resources { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.AuditEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.AuditEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.AuditEvent();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "actor", n => { Actor = n.GetObjectValue<global::MissAlise.OneDrive.Models.AuditActor>(global::MissAlise.OneDrive.Models.AuditActor.CreateFromDiscriminatorValue); } },
                { "category", n => { Category = n.GetStringValue(); } },
                { "componentName", n => { ComponentName = n.GetStringValue(); } },
                { "correlationId", n => { CorrelationId = n.GetGuidValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "resources", n => { Resources = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.AuditResource>(global::MissAlise.OneDrive.Models.AuditResource.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.AuditActor>("actor", Actor);
            writer.WriteStringValue("category", Category);
            writer.WriteStringValue("componentName", ComponentName);
            writer.WriteGuidValue("correlationId", CorrelationId);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.AuditResource>("resources", Resources);
        }
    }
}
