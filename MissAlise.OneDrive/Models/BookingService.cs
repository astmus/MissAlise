...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class BookingService : global::MissAlise.OneDrive.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.BookingQuestionAssignment>? CustomQuestions { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.BookingQuestionAssignment> CustomQuestions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.Location? DefaultLocation { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.Location DefaultLocation { get; set; }
#endif
        ...
        public global::MissAlise.OneDrive.Models.BookingPriceType? DefaultPriceType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.BookingReminder>? DefaultReminders { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.BookingReminder> DefaultReminders { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.BookingService"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.BookingService CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.BookingService();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "customQuestions", n => { CustomQuestions = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingQuestionAssignment>(global::MissAlise.OneDrive.Models.BookingQuestionAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "defaultDuration", n => { DefaultDuration = n.GetTimeSpanValue(); } },
                { "defaultLocation", n => { DefaultLocation = n.GetObjectValue<global::MissAlise.OneDrive.Models.Location>(global::MissAlise.OneDrive.Models.Location.CreateFromDiscriminatorValue); } },
                { "defaultPrice", n => { DefaultPrice = n.GetDoubleValue(); } },
                { "defaultPriceType", n => { DefaultPriceType = n.GetEnumValue<global::MissAlise.OneDrive.Models.BookingPriceType>(); } },
                { "defaultReminders", n => { DefaultReminders = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingReminder>(global::MissAlise.OneDrive.Models.BookingReminder.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingQuestionAssignment>("customQuestions", CustomQuestions);
            writer.WriteTimeSpanValue("defaultDuration", DefaultDuration);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.Location>("defaultLocation", DefaultLocation);
            writer.WriteDoubleValue("defaultPrice", DefaultPrice);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.BookingPriceType>("defaultPriceType", DefaultPriceType);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingReminder>("defaultReminders", DefaultReminders);
