...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class StandardTimeZoneOffset : IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::MissAlise.OneDrive.Models.DayOfWeekObject? DayOfWeek { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.StandardTimeZoneOffset"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.StandardTimeZoneOffset CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("@odata.type")?.GetStringValue();
            return mappingValue switch
            {
                "#microsoft.graph.daylightTimeZoneOffset" => new global::MissAlise.OneDrive.Models.DaylightTimeZoneOffset(),
                _ => new global::MissAlise.OneDrive.Models.StandardTimeZoneOffset(),
            };
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "dayOfWeek", n => { DayOfWeek = n.GetEnumValue<global::MissAlise.OneDrive.Models.DayOfWeekObject>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.DayOfWeekObject>("dayOfWeek", DayOfWeek);
