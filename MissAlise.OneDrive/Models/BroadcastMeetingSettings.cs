...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class BroadcastMeetingSettings : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Defines who can join the Teams live event. Possible values are listed in the following table.</summary>
        public global::MissAlise.OneDrive.Models.BroadcastMeetingAudience? AllowedAudience { get; set; }
        /// <summary>Caption settings of a Teams live event.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.BroadcastMeetingCaptionSettings? Captions { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.BroadcastMeetingCaptionSettings Captions { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.BroadcastMeetingSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.BroadcastMeetingSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.BroadcastMeetingSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedAudience", n => { AllowedAudience = n.GetEnumValue<global::MissAlise.OneDrive.Models.BroadcastMeetingAudience>(); } },
                { "captions", n => { Captions = n.GetObjectValue<global::MissAlise.OneDrive.Models.BroadcastMeetingCaptionSettings>(global::MissAlise.OneDrive.Models.BroadcastMeetingCaptionSettings.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.BroadcastMeetingAudience>("allowedAudience", AllowedAudience);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.BroadcastMeetingCaptionSettings>("captions", Captions);
