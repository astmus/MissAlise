...
namespace MissAlise.OneDrive.Models.CallRecords
{
    ...
    public partial class NetworkInfo : IParsable
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.CallRecords.NetworkConnectionType? ConnectionType { get; set; }
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.CallRecords.NetworkTransportProtocol? NetworkTransportProtocol { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.CallRecords.TraceRouteHop>? TraceRouteHops { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.CallRecords.TraceRouteHop> TraceRouteHops { get; set; }
#endif
        /// <summary>The wifiBand property</summary>
        public global::MissAlise.OneDrive.Models.CallRecords.WifiBand? WifiBand { get; set; }
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.CallRecords.WifiRadioType? WifiRadioType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.CallRecords.NetworkInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.CallRecords.NetworkInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.CallRecords.NetworkInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "connectionType", n => { ConnectionType = n.GetEnumValue<global::MissAlise.OneDrive.Models.CallRecords.NetworkConnectionType>(); } },
                ...
                { "networkTransportProtocol", n => { NetworkTransportProtocol = n.GetEnumValue<global::MissAlise.OneDrive.Models.CallRecords.NetworkTransportProtocol>(); } },
                ...
                { "traceRouteHops", n => { TraceRouteHops = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.CallRecords.TraceRouteHop>(global::MissAlise.OneDrive.Models.CallRecords.TraceRouteHop.CreateFromDiscriminatorValue)?.AsList(); } },
                { "wifiBand", n => { WifiBand = n.GetEnumValue<global::MissAlise.OneDrive.Models.CallRecords.WifiBand>(); } },
                ...
                { "wifiRadioType", n => { WifiRadioType = n.GetEnumValue<global::MissAlise.OneDrive.Models.CallRecords.WifiRadioType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.CallRecords.NetworkConnectionType>("connectionType", ConnectionType);
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.CallRecords.NetworkTransportProtocol>("networkTransportProtocol", NetworkTransportProtocol);
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.CallRecords.TraceRouteHop>("traceRouteHops", TraceRouteHops);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.CallRecords.WifiBand>("wifiBand", WifiBand);
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.CallRecords.WifiRadioType>("wifiRadioType", WifiRadioType);
