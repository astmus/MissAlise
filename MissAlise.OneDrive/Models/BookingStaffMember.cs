...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class BookingStaffMember : global::MissAlise.OneDrive.Models.BookingStaffMemberBase, IParsable
    {
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.BookingStaffMembershipStatus? MembershipStatus { get; set; }
        /// <summary>The role property</summary>
        public global::MissAlise.OneDrive.Models.BookingStaffRole? Role { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.BookingWorkHours>? WorkingHours { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.BookingWorkHours> WorkingHours { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::MissAlise.OneDrive.Models.BookingStaffMember"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.BookingStaffMember"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.BookingStaffMember CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.BookingStaffMember();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "membershipStatus", n => { MembershipStatus = n.GetEnumValue<global::MissAlise.OneDrive.Models.BookingStaffMembershipStatus>(); } },
                { "role", n => { Role = n.GetEnumValue<global::MissAlise.OneDrive.Models.BookingStaffRole>(); } },
                { "timeZone", n => { TimeZone = n.GetStringValue(); } },
                { "useBusinessHours", n => { UseBusinessHours = n.GetBoolValue(); } },
                { "workingHours", n => { WorkingHours = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingWorkHours>(global::MissAlise.OneDrive.Models.BookingWorkHours.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.BookingStaffMembershipStatus>("membershipStatus", MembershipStatus);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.BookingStaffRole>("role", Role);
            writer.WriteStringValue("timeZone", TimeZone);
            writer.WriteBoolValue("useBusinessHours", UseBusinessHours);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingWorkHours>("workingHours", WorkingHours);
        }
    }
}
