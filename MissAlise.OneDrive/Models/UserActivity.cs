...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class UserActivity : global::MissAlise.OneDrive.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.ActivityHistoryItem>? HistoryItems { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.ActivityHistoryItem> HistoryItems { get; set; }
#endif
        ...
        public global::MissAlise.OneDrive.Models.Status? Status { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.VisualInfo? VisualElements { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.VisualInfo VisualElements { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.UserActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.UserActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.UserActivity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "historyItems", n => { HistoryItems = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.ActivityHistoryItem>(global::MissAlise.OneDrive.Models.ActivityHistoryItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::MissAlise.OneDrive.Models.Status>(); } },
                { "userTimezone", n => { UserTimezone = n.GetStringValue(); } },
                { "visualElements", n => { VisualElements = n.GetObjectValue<global::MissAlise.OneDrive.Models.VisualInfo>(global::MissAlise.OneDrive.Models.VisualInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.ActivityHistoryItem>("historyItems", HistoryItems);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.Status>("status", Status);
            writer.WriteStringValue("userTimezone", UserTimezone);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.VisualInfo>("visualElements", VisualElements);
        }
    }
}
