...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class SynchronizationTemplate : global::MissAlise.OneDrive.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.SynchronizationMetadataEntry>? Metadata { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.SynchronizationMetadataEntry> Metadata { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.SynchronizationTemplate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.SynchronizationTemplate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.SynchronizationTemplate();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "metadata", n => { Metadata = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.SynchronizationMetadataEntry>(global::MissAlise.OneDrive.Models.SynchronizationMetadataEntry.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.SynchronizationMetadataEntry>("metadata", Metadata);
