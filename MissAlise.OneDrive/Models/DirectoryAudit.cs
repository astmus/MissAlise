...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class DirectoryAudit : global::MissAlise.OneDrive.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.KeyValue>? AdditionalDetails { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.KeyValue> AdditionalDetails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.AuditActivityInitiator? InitiatedBy { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.AuditActivityInitiator InitiatedBy { get; set; }
#endif
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.OperationResult? Result { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.TargetResource>? TargetResources { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.TargetResource> TargetResources { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.DirectoryAudit"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.DirectoryAudit CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.DirectoryAudit();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "additionalDetails", n => { AdditionalDetails = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.KeyValue>(global::MissAlise.OneDrive.Models.KeyValue.CreateFromDiscriminatorValue)?.AsList(); } },
                { "category", n => { Category = n.GetStringValue(); } },
                { "correlationId", n => { CorrelationId = n.GetStringValue(); } },
                { "initiatedBy", n => { InitiatedBy = n.GetObjectValue<global::MissAlise.OneDrive.Models.AuditActivityInitiator>(global::MissAlise.OneDrive.Models.AuditActivityInitiator.CreateFromDiscriminatorValue); } },
                { "loggedByService", n => { LoggedByService = n.GetStringValue(); } },
                { "operationType", n => { OperationType = n.GetStringValue(); } },
                { "result", n => { Result = n.GetEnumValue<global::MissAlise.OneDrive.Models.OperationResult>(); } },
                { "resultReason", n => { ResultReason = n.GetStringValue(); } },
                { "targetResources", n => { TargetResources = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.TargetResource>(global::MissAlise.OneDrive.Models.TargetResource.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.KeyValue>("additionalDetails", AdditionalDetails);
            writer.WriteStringValue("category", Category);
            writer.WriteStringValue("correlationId", CorrelationId);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.AuditActivityInitiator>("initiatedBy", InitiatedBy);
            writer.WriteStringValue("loggedByService", LoggedByService);
            writer.WriteStringValue("operationType", OperationType);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.OperationResult>("result", Result);
            writer.WriteStringValue("resultReason", ResultReason);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.TargetResource>("targetResources", TargetResources);
        }
    }
}
