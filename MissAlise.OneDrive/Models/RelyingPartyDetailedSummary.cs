...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class RelyingPartyDetailedSummary : global::MissAlise.OneDrive.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::MissAlise.OneDrive.Models.MigrationStatus? MigrationStatus { get; set; }
        /// <summary>Specifies all the validations checks done on applications config details.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.KeyValuePair>? MigrationValidationDetails { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.KeyValuePair> MigrationValidationDetails { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.RelyingPartyDetailedSummary"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.RelyingPartyDetailedSummary CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.RelyingPartyDetailedSummary();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "migrationStatus", n => { MigrationStatus = n.GetEnumValue<global::MissAlise.OneDrive.Models.MigrationStatus>(); } },
                { "migrationValidationDetails", n => { MigrationValidationDetails = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.KeyValuePair>(global::MissAlise.OneDrive.Models.KeyValuePair.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.MigrationStatus>("migrationStatus", MigrationStatus);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.KeyValuePair>("migrationValidationDetails", MigrationValidationDetails);
