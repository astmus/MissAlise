...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class Process : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.FileHash? FileHash { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.FileHash FileHash { get; set; }
#endif
        /// <summary>The integrity level of the process. Possible values are: unknown, untrusted, low, medium, high, system.</summary>
        public global::MissAlise.OneDrive.Models.ProcessIntegrityLevel? IntegrityLevel { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.Process"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.Process CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.Process();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fileHash", n => { FileHash = n.GetObjectValue<global::MissAlise.OneDrive.Models.FileHash>(global::MissAlise.OneDrive.Models.FileHash.CreateFromDiscriminatorValue); } },
                { "integrityLevel", n => { IntegrityLevel = n.GetEnumValue<global::MissAlise.OneDrive.Models.ProcessIntegrityLevel>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.FileHash>("fileHash", FileHash);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.ProcessIntegrityLevel>("integrityLevel", IntegrityLevel);
