...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class Drive : global::MissAlise.OneDrive.Models.BaseItem, IParsable
...
#nullable enable
        public List<global::MissAlise.OneDrive.Models.DriveItem>? Bundles { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.DriveItem> Bundles { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.DriveItem>? Following { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.DriveItem> Following { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.Quota? Quota { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.Quota Quota { get; set; }
#endif
...
#nullable restore
        ...
        public static new global::MissAlise.OneDrive.Models.Drive CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.Drive();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "bundles", n => { Bundles = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.DriveItem>(global::MissAlise.OneDrive.Models.DriveItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "driveType", n => { DriveType = n.GetStringValue(); } },
                { "following", n => { Following = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.DriveItem>(global::MissAlise.OneDrive.Models.DriveItem.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.DriveItem>("bundles", Bundles);
            writer.WriteStringValue("driveType", DriveType);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.DriveItem>("following", Following);
