...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class CustomSecurityAttributeDefinition : global::MissAlise.OneDrive.Models.Entity, IParsable
...
#nullable enable
        public List<global::MissAlise.OneDrive.Models.AllowedValue>? AllowedValues { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.AllowedValue> AllowedValues { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.CustomSecurityAttributeDefinition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.CustomSecurityAttributeDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.CustomSecurityAttributeDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedValues", n => { AllowedValues = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.AllowedValue>(global::MissAlise.OneDrive.Models.AllowedValue.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.AllowedValue>("allowedValues", AllowedValues);
