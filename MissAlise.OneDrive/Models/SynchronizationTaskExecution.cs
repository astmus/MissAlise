...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class SynchronizationTaskExecution : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.SynchronizationError? Error { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.SynchronizationError Error { get; set; }
#endif
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.SynchronizationTaskExecutionResult? State { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.SynchronizationTaskExecution"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.SynchronizationTaskExecution CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.SynchronizationTaskExecution();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "error", n => { Error = n.GetObjectValue<global::MissAlise.OneDrive.Models.SynchronizationError>(global::MissAlise.OneDrive.Models.SynchronizationError.CreateFromDiscriminatorValue); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "state", n => { State = n.GetEnumValue<global::MissAlise.OneDrive.Models.SynchronizationTaskExecutionResult>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.SynchronizationError>("error", Error);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.SynchronizationTaskExecutionResult>("state", State);
