...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class BookingAppointment : global::MissAlise.OneDrive.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.BookingCustomerInformationBase>? Customers { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.BookingCustomerInformationBase> Customers { get; set; }
#endif
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.BookingPriceType? PriceType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.BookingReminder>? Reminders { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.BookingReminder> Reminders { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.Location? ServiceLocation { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.Location ServiceLocation { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.BookingAppointment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.BookingAppointment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.BookingAppointment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "customers", n => { Customers = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingCustomerInformationBase>(global::MissAlise.OneDrive.Models.BookingCustomerInformationBase.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "priceType", n => { PriceType = n.GetEnumValue<global::MissAlise.OneDrive.Models.BookingPriceType>(); } },
                { "reminders", n => { Reminders = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingReminder>(global::MissAlise.OneDrive.Models.BookingReminder.CreateFromDiscriminatorValue)?.AsList(); } },
                { "selfServiceAppointmentId", n => { SelfServiceAppointmentId = n.GetStringValue(); } },
                { "serviceId", n => { ServiceId = n.GetStringValue(); } },
                { "serviceLocation", n => { ServiceLocation = n.GetObjectValue<global::MissAlise.OneDrive.Models.Location>(global::MissAlise.OneDrive.Models.Location.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingCustomerInformationBase>("customers", Customers);
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.BookingPriceType>("priceType", PriceType);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingReminder>("reminders", Reminders);
            writer.WriteStringValue("selfServiceAppointmentId", SelfServiceAppointmentId);
            writer.WriteStringValue("serviceId", ServiceId);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.Location>("serviceLocation", ServiceLocation);
