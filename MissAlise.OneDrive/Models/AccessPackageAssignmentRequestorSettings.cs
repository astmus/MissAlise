...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class AccessPackageAssignmentRequestorSettings : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.SubjectSet>? OnBehalfRequestors { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.SubjectSet> OnBehalfRequestors { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.AccessPackageAssignmentRequestorSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.AccessPackageAssignmentRequestorSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.AccessPackageAssignmentRequestorSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "onBehalfRequestors", n => { OnBehalfRequestors = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.SubjectSet>(global::MissAlise.OneDrive.Models.SubjectSet.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.SubjectSet>("onBehalfRequestors", OnBehalfRequestors);
        }
    }
}
