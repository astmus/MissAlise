...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class WindowsAutopilotDeploymentProfile : global::MissAlise.OneDrive.Models.Entity, IParsable
    {
        /// <summary>The list of assigned devices for the profile.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.WindowsAutopilotDeviceIdentity>? AssignedDevices { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.WindowsAutopilotDeviceIdentity> AssignedDevices { get; set; }
#endif
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.WindowsAutopilotDeviceType? DeviceType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.OutOfBoxExperienceSetting? OutOfBoxExperienceSetting { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.OutOfBoxExperienceSetting OutOfBoxExperienceSetting { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.WindowsAutopilotDeploymentProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.WindowsAutopilotDeploymentProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.WindowsAutopilotDeploymentProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignedDevices", n => { AssignedDevices = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.WindowsAutopilotDeviceIdentity>(global::MissAlise.OneDrive.Models.WindowsAutopilotDeviceIdentity.CreateFromDiscriminatorValue)?.AsList(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "deviceNameTemplate", n => { DeviceNameTemplate = n.GetStringValue(); } },
                { "deviceType", n => { DeviceType = n.GetEnumValue<global::MissAlise.OneDrive.Models.WindowsAutopilotDeviceType>(); } },
                ...
                { "outOfBoxExperienceSetting", n => { OutOfBoxExperienceSetting = n.GetObjectValue<global::MissAlise.OneDrive.Models.OutOfBoxExperienceSetting>(global::MissAlise.OneDrive.Models.OutOfBoxExperienceSetting.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.WindowsAutopilotDeviceIdentity>("assignedDevices", AssignedDevices);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("deviceNameTemplate", DeviceNameTemplate);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.WindowsAutopilotDeviceType>("deviceType", DeviceType);
            ...
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.OutOfBoxExperienceSetting>("outOfBoxExperienceSetting", OutOfBoxExperienceSetting);
