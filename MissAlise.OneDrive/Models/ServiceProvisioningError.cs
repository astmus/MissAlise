...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class ServiceProvisioningError : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.ServiceProvisioningError"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.ServiceProvisioningError CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("@odata.type")?.GetStringValue();
            return mappingValue switch
            {
                "#microsoft.graph.serviceProvisioningXmlError" => new global::MissAlise.OneDrive.Models.ServiceProvisioningXmlError(),
                _ => new global::MissAlise.OneDrive.Models.ServiceProvisioningError(),
            };
        }
        /// <summary>
