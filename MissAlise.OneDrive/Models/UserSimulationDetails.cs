...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class UserSimulationDetails : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.UserSimulationEventInfo>? SimulationEvents { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.UserSimulationEventInfo> SimulationEvents { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.AttackSimulationUser? SimulationUser { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.AttackSimulationUser SimulationUser { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.UserTrainingEventInfo>? TrainingEvents { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.UserTrainingEventInfo> TrainingEvents { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.UserSimulationDetails"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.UserSimulationDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.UserSimulationDetails();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "simulationEvents", n => { SimulationEvents = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.UserSimulationEventInfo>(global::MissAlise.OneDrive.Models.UserSimulationEventInfo.CreateFromDiscriminatorValue)?.AsList(); } },
                { "simulationUser", n => { SimulationUser = n.GetObjectValue<global::MissAlise.OneDrive.Models.AttackSimulationUser>(global::MissAlise.OneDrive.Models.AttackSimulationUser.CreateFromDiscriminatorValue); } },
                { "trainingEvents", n => { TrainingEvents = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.UserTrainingEventInfo>(global::MissAlise.OneDrive.Models.UserTrainingEventInfo.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.UserSimulationEventInfo>("simulationEvents", SimulationEvents);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.AttackSimulationUser>("simulationUser", SimulationUser);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.UserTrainingEventInfo>("trainingEvents", TrainingEvents);
        }
    }
}
