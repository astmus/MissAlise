...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class Organization : global::MissAlise.OneDrive.Models.DirectoryObject, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.OrganizationalBranding? Branding { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.OrganizationalBranding Branding { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.CertificateBasedAuthConfiguration>? CertificateBasedAuthConfiguration { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.CertificateBasedAuthConfiguration> CertificateBasedAuthConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.MdmAuthority? MobileDeviceManagementAuthority { get; set; }
        ...
        public global::MissAlise.OneDrive.Models.PartnerTenantType? PartnerTenantType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.PrivacyProfile? PrivacyProfile { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.PrivacyProfile PrivacyProfile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.VerifiedDomain>? VerifiedDomains { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.VerifiedDomain> VerifiedDomains { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::MissAlise.OneDrive.Models.Organization"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.Organization"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.Organization CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.Organization();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "branding", n => { Branding = n.GetObjectValue<global::MissAlise.OneDrive.Models.OrganizationalBranding>(global::MissAlise.OneDrive.Models.OrganizationalBranding.CreateFromDiscriminatorValue); } },
                { "businessPhones", n => { BusinessPhones = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "certificateBasedAuthConfiguration", n => { CertificateBasedAuthConfiguration = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.CertificateBasedAuthConfiguration>(global::MissAlise.OneDrive.Models.CertificateBasedAuthConfiguration.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "mobileDeviceManagementAuthority", n => { MobileDeviceManagementAuthority = n.GetEnumValue<global::MissAlise.OneDrive.Models.MdmAuthority>(); } },
                { "onPremisesLastSyncDateTime", n => { OnPremisesLastSyncDateTime = n.GetDateTimeOffsetValue(); } },
                { "onPremisesSyncEnabled", n => { OnPremisesSyncEnabled = n.GetBoolValue(); } },
                { "partnerTenantType", n => { PartnerTenantType = n.GetEnumValue<global::MissAlise.OneDrive.Models.PartnerTenantType>(); } },
                { "postalCode", n => { PostalCode = n.GetStringValue(); } },
                { "preferredLanguage", n => { PreferredLanguage = n.GetStringValue(); } },
                { "privacyProfile", n => { PrivacyProfile = n.GetObjectValue<global::MissAlise.OneDrive.Models.PrivacyProfile>(global::MissAlise.OneDrive.Models.PrivacyProfile.CreateFromDiscriminatorValue); } },
                ...
                { "verifiedDomains", n => { VerifiedDomains = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.VerifiedDomain>(global::MissAlise.OneDrive.Models.VerifiedDomain.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.OrganizationalBranding>("branding", Branding);
            writer.WriteCollectionOfPrimitiveValues<string>("businessPhones", BusinessPhones);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.CertificateBasedAuthConfiguration>("certificateBasedAuthConfiguration", CertificateBasedAuthConfiguration);
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.MdmAuthority>("mobileDeviceManagementAuthority", MobileDeviceManagementAuthority);
            writer.WriteDateTimeOffsetValue("onPremisesLastSyncDateTime", OnPremisesLastSyncDateTime);
            writer.WriteBoolValue("onPremisesSyncEnabled", OnPremisesSyncEnabled);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.PartnerTenantType>("partnerTenantType", PartnerTenantType);
            writer.WriteStringValue("postalCode", PostalCode);
            writer.WriteStringValue("preferredLanguage", PreferredLanguage);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.PrivacyProfile>("privacyProfile", PrivacyProfile);
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.VerifiedDomain>("verifiedDomains", VerifiedDomains);
        }
    }
}
