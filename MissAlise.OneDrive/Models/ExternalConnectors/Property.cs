...
namespace MissAlise.OneDrive.Models.ExternalConnectors
{
    ...
    public partial class Property : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.ExternalConnectors.Label?>? Labels { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.ExternalConnectors.Label?> Labels { get; set; }
#endif
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.ExternalConnectors.PropertyType? Type { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.ExternalConnectors.Property"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.ExternalConnectors.Property CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.ExternalConnectors.Property();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "labels", n => { Labels = n.GetCollectionOfEnumValues<global::MissAlise.OneDrive.Models.ExternalConnectors.Label>()?.AsList(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::MissAlise.OneDrive.Models.ExternalConnectors.PropertyType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::MissAlise.OneDrive.Models.ExternalConnectors.Label>("labels", Labels);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.ExternalConnectors.PropertyType>("type", Type);
        }
    }
}
