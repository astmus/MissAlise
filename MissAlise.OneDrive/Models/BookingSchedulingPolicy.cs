...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class BookingSchedulingPolicy : IParsable
    {
...
#nullable enable
        public List<global::MissAlise.OneDrive.Models.BookingsAvailabilityWindow>? CustomAvailabilities { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.BookingsAvailabilityWindow> CustomAvailabilities { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.BookingsAvailability? GeneralAvailability { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.BookingsAvailability GeneralAvailability { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.BookingSchedulingPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.BookingSchedulingPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.BookingSchedulingPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "customAvailabilities", n => { CustomAvailabilities = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingsAvailabilityWindow>(global::MissAlise.OneDrive.Models.BookingsAvailabilityWindow.CreateFromDiscriminatorValue)?.AsList(); } },
                { "generalAvailability", n => { GeneralAvailability = n.GetObjectValue<global::MissAlise.OneDrive.Models.BookingsAvailability>(global::MissAlise.OneDrive.Models.BookingsAvailability.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.BookingsAvailabilityWindow>("customAvailabilities", CustomAvailabilities);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.BookingsAvailability>("generalAvailability", GeneralAvailability);
