...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class LearningProvider : global::MissAlise.OneDrive.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.LearningContent>? LearningContents { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.LearningContent> LearningContents { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.LearningCourseActivity>? LearningCourseActivities { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.LearningCourseActivity> LearningCourseActivities { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.LearningProvider"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.LearningProvider CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.LearningProvider();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "learningContents", n => { LearningContents = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.LearningContent>(global::MissAlise.OneDrive.Models.LearningContent.CreateFromDiscriminatorValue)?.AsList(); } },
                { "learningCourseActivities", n => { LearningCourseActivities = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.LearningCourseActivity>(global::MissAlise.OneDrive.Models.LearningCourseActivity.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.LearningContent>("learningContents", LearningContents);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.LearningCourseActivity>("learningCourseActivities", LearningCourseActivities);
