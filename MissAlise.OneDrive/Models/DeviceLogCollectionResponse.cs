...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class DeviceLogCollectionResponse : global::MissAlise.OneDrive.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.AppLogUploadState? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.DeviceLogCollectionResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.DeviceLogCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.DeviceLogCollectionResponse();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::MissAlise.OneDrive.Models.AppLogUploadState>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.AppLogUploadState>("status", Status);
        }
    }
}
