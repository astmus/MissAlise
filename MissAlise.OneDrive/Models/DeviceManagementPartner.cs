...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class DeviceManagementPartner : global::MissAlise.OneDrive.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.DeviceManagementPartnerAssignment>? GroupsRequiringPartnerEnrollment { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.DeviceManagementPartnerAssignment> GroupsRequiringPartnerEnrollment { get; set; }
#endif
        ...
        public global::MissAlise.OneDrive.Models.DeviceManagementPartnerAppType? PartnerAppType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.DeviceManagementPartner"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.DeviceManagementPartner CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.DeviceManagementPartner();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "groupsRequiringPartnerEnrollment", n => { GroupsRequiringPartnerEnrollment = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.DeviceManagementPartnerAssignment>(global::MissAlise.OneDrive.Models.DeviceManagementPartnerAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "isConfigured", n => { IsConfigured = n.GetBoolValue(); } },
                { "lastHeartbeatDateTime", n => { LastHeartbeatDateTime = n.GetDateTimeOffsetValue(); } },
                { "partnerAppType", n => { PartnerAppType = n.GetEnumValue<global::MissAlise.OneDrive.Models.DeviceManagementPartnerAppType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.DeviceManagementPartnerAssignment>("groupsRequiringPartnerEnrollment", GroupsRequiringPartnerEnrollment);
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.DeviceManagementPartnerAppType>("partnerAppType", PartnerAppType);
