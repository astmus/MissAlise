...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class InternalDomainFederation : global::MissAlise.OneDrive.Models.SamlOrWsFedProvider, IParsable
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.FederatedIdpMfaBehavior? FederatedIdpMfaBehavior { get; set; }
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.PromptLoginBehavior? PromptLoginBehavior { get; set; }
        /// <summary>Provides status and timestamp of the last update of the signing certificate.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::MissAlise.OneDrive.Models.SigningCertificateUpdateStatus? SigningCertificateUpdateStatus { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.SigningCertificateUpdateStatus SigningCertificateUpdateStatus { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::MissAlise.OneDrive.Models.InternalDomainFederation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.InternalDomainFederation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.InternalDomainFederation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.InternalDomainFederation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "federatedIdpMfaBehavior", n => { FederatedIdpMfaBehavior = n.GetEnumValue<global::MissAlise.OneDrive.Models.FederatedIdpMfaBehavior>(); } },
                ...
                { "promptLoginBehavior", n => { PromptLoginBehavior = n.GetEnumValue<global::MissAlise.OneDrive.Models.PromptLoginBehavior>(); } },
                { "signOutUri", n => { SignOutUri = n.GetStringValue(); } },
                { "signingCertificateUpdateStatus", n => { SigningCertificateUpdateStatus = n.GetObjectValue<global::MissAlise.OneDrive.Models.SigningCertificateUpdateStatus>(global::MissAlise.OneDrive.Models.SigningCertificateUpdateStatus.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.FederatedIdpMfaBehavior>("federatedIdpMfaBehavior", FederatedIdpMfaBehavior);
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.PromptLoginBehavior>("promptLoginBehavior", PromptLoginBehavior);
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.SigningCertificateUpdateStatus>("signingCertificateUpdateStatus", SigningCertificateUpdateStatus);
