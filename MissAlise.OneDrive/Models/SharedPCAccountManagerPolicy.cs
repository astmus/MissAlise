...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class SharedPCAccountManagerPolicy : IParsable
    {
        /// <summary>Possible values for when accounts are deleted on a shared PC.</summary>
        public global::MissAlise.OneDrive.Models.SharedPCAccountDeletionPolicyType? AccountDeletionPolicy { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.SharedPCAccountManagerPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.SharedPCAccountManagerPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.SharedPCAccountManagerPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accountDeletionPolicy", n => { AccountDeletionPolicy = n.GetEnumValue<global::MissAlise.OneDrive.Models.SharedPCAccountDeletionPolicyType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.SharedPCAccountDeletionPolicyType>("accountDeletionPolicy", AccountDeletionPolicy);
