...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class SecureScoreControlProfile : global::MissAlise.OneDrive.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.ComplianceInformation>? ComplianceInformation { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.ComplianceInformation> ComplianceInformation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.SecureScoreControlStateUpdate>? ControlStateUpdates { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.SecureScoreControlStateUpdate> ControlStateUpdates { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.SecureScoreControlProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.SecureScoreControlProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.SecureScoreControlProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "complianceInformation", n => { ComplianceInformation = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.ComplianceInformation>(global::MissAlise.OneDrive.Models.ComplianceInformation.CreateFromDiscriminatorValue)?.AsList(); } },
                { "controlCategory", n => { ControlCategory = n.GetStringValue(); } },
                { "controlStateUpdates", n => { ControlStateUpdates = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.SecureScoreControlStateUpdate>(global::MissAlise.OneDrive.Models.SecureScoreControlStateUpdate.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.ComplianceInformation>("complianceInformation", ComplianceInformation);
            writer.WriteStringValue("controlCategory", ControlCategory);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.SecureScoreControlStateUpdate>("controlStateUpdates", ControlStateUpdates);
