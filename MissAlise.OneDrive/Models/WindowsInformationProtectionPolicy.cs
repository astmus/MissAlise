...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class WindowsInformationProtectionPolicy : global::MissAlise.OneDrive.Models.WindowsInformationProtection, IParsable
    {
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements? PinLowercaseLetters { get; set; }
        ...
        /// <summary>Pin Character Requirements</summary>
        public global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements? PinSpecialCharacters { get; set; }
        /// <summary>Pin Character Requirements</summary>
        public global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements? PinUppercaseLetters { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::MissAlise.OneDrive.Models.WindowsInformationProtectionPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.WindowsInformationProtectionPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.WindowsInformationProtectionPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.WindowsInformationProtectionPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "pinLowercaseLetters", n => { PinLowercaseLetters = n.GetEnumValue<global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinMinimumLength", n => { PinMinimumLength = n.GetIntValue(); } },
                { "pinSpecialCharacters", n => { PinSpecialCharacters = n.GetEnumValue<global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinUppercaseLetters", n => { PinUppercaseLetters = n.GetEnumValue<global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements>("pinLowercaseLetters", PinLowercaseLetters);
            writer.WriteIntValue("pinMinimumLength", PinMinimumLength);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements>("pinSpecialCharacters", PinSpecialCharacters);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.WindowsInformationProtectionPinCharacterRequirements>("pinUppercaseLetters", PinUppercaseLetters);
