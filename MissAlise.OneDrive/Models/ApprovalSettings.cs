...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class ApprovalSettings : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.UnifiedApprovalStage>? ApprovalStages { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.UnifiedApprovalStage> ApprovalStages { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.ApprovalSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.ApprovalSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.ApprovalSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "approvalStages", n => { ApprovalStages = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.UnifiedApprovalStage>(global::MissAlise.OneDrive.Models.UnifiedApprovalStage.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.UnifiedApprovalStage>("approvalStages", ApprovalStages);
