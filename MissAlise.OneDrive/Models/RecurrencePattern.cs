...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class RecurrencePattern : IParsable
...
#nullable enable
        public List<global::MissAlise.OneDrive.Models.DayOfWeekObject?>? DaysOfWeek { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.DayOfWeekObject?> DaysOfWeek { get; set; }
#endif
        ...
        public global::MissAlise.OneDrive.Models.DayOfWeekObject? FirstDayOfWeek { get; set; }
        ...
        public global::MissAlise.OneDrive.Models.WeekIndex? Index { get; set; }
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.RecurrencePatternType? Type { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.RecurrencePattern"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.RecurrencePattern CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.RecurrencePattern();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "daysOfWeek", n => { DaysOfWeek = n.GetCollectionOfEnumValues<global::MissAlise.OneDrive.Models.DayOfWeekObject>()?.AsList(); } },
                { "firstDayOfWeek", n => { FirstDayOfWeek = n.GetEnumValue<global::MissAlise.OneDrive.Models.DayOfWeekObject>(); } },
                { "index", n => { Index = n.GetEnumValue<global::MissAlise.OneDrive.Models.WeekIndex>(); } },
                { "interval", n => { Interval = n.GetIntValue(); } },
                { "month", n => { Month = n.GetIntValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::MissAlise.OneDrive.Models.RecurrencePatternType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::MissAlise.OneDrive.Models.DayOfWeekObject>("daysOfWeek", DaysOfWeek);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.DayOfWeekObject>("firstDayOfWeek", FirstDayOfWeek);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.WeekIndex>("index", Index);
            writer.WriteIntValue("interval", Interval);
            writer.WriteIntValue("month", Month);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.RecurrencePatternType>("type", Type);
        }
    }
}
