...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class SharedPCConfiguration : global::MissAlise.OneDrive.Models.DeviceConfiguration, IParsable
    {
...
#nullable enable
        public global::MissAlise.OneDrive.Models.SharedPCAccountManagerPolicy? AccountManagerPolicy { get; set; }
#nullable restore
#else
        public global::MissAlise.OneDrive.Models.SharedPCAccountManagerPolicy AccountManagerPolicy { get; set; }
#endif
        /// <summary>Type of accounts that are allowed to share the PC.</summary>
        public global::MissAlise.OneDrive.Models.SharedPCAllowedAccountType? AllowedAccounts { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::MissAlise.OneDrive.Models.SharedPCConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.SharedPCConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::MissAlise.OneDrive.Models.SharedPCConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.SharedPCConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accountManagerPolicy", n => { AccountManagerPolicy = n.GetObjectValue<global::MissAlise.OneDrive.Models.SharedPCAccountManagerPolicy>(global::MissAlise.OneDrive.Models.SharedPCAccountManagerPolicy.CreateFromDiscriminatorValue); } },
                { "allowLocalStorage", n => { AllowLocalStorage = n.GetBoolValue(); } },
                { "allowedAccounts", n => { AllowedAccounts = n.GetEnumValue<global::MissAlise.OneDrive.Models.SharedPCAllowedAccountType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::MissAlise.OneDrive.Models.SharedPCAccountManagerPolicy>("accountManagerPolicy", AccountManagerPolicy);
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.SharedPCAllowedAccountType>("allowedAccounts", AllowedAccounts);
