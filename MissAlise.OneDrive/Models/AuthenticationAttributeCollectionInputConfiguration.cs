...
namespace MissAlise.OneDrive.Models
{
    ...
    public partial class AuthenticationAttributeCollectionInputConfiguration : IParsable
...
#nullable restore
        ...
        public global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionInputType? InputType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionOptionConfiguration>? Options { get; set; }
#nullable restore
#else
        public List<global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionOptionConfiguration> Options { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionInputConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionInputConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionInputConfiguration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "inputType", n => { InputType = n.GetEnumValue<global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionInputType>(); } },
                { "label", n => { Label = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "options", n => { Options = n.GetCollectionOfObjectValues<global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionOptionConfiguration>(global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionOptionConfiguration.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionInputType>("inputType", InputType);
            writer.WriteStringValue("label", Label);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteCollectionOfObjectValues<global::MissAlise.OneDrive.Models.AuthenticationAttributeCollectionOptionConfiguration>("options", Options);
