...
namespace MissAlise.OneDrive
{
	class AuthHeaderHandler : DelegatingHandler
	{
		...
		public AuthHeaderHandler(IOptions<AzureAd> config, IOneDriveCredentialsService credentialService, IUserProfilesRepository profiles, ILogger<AuthHeaderHandler> logger)
		{
